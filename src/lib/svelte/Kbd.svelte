...
<kbd
    class="min-h-[30px] inline-flex justify-center items-center py-1 px-1.5 border font-mono text-sm rounded-md {getCssColours()} {className}"
>
    <slot />
</kbd>
